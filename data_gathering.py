...
def get_active_command():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"[Server] Status {response.status_code} at {CONTROL_URL}")
    except Exception:
        pass
    return None
...
def start_camera():
    ...
    try:
        ...
        threading.Thread(target=monitor_camera, args=(cam_proc,), daemon=True).start()
        return cam_proc
    except Exception as e:
